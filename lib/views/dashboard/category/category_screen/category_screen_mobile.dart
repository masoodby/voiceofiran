  ...
  _categoryGridWidget(context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        // my test
        // print("test ${snapshot.data[0]["title"]}");
         ...
         return SizedBox(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              var categoryData = snapshot.data[index];
              String categoryImageUrl = categoryData["image"].toString();
              String categoryName = categoryData["title"].toString();
              return Visibility(
                visible: true,
                child: InkWell(
                  onTap: () {
                  ...
                  child: Stack(
                    children: [
                      ...
                      Container(
                       ...
                       decoration: BoxDecoration(color: const Color.fromARGB(255, 21, 20, 20).withOpacity(0.5)),
                        child: Padding(
                          padding: EdgeInsets.symmetric(
